...
module.exports = {
    ...
    tenorKey: "CHANGEME", // tenor api key, can leave as is but will result in a lack of tenor functionality - No longer works, left inside for legacy programs.
    klipyKey: "CHANGEME", // klipy api key key - works
    ...
    spamWarn: 7, // how many messages before warning (trying to DM) - set all values except for dedlay to 2147483647 to effectively disable
    ...
    // Do not change these. Used for version checking, command line functionality, and more.
    version: "0.3.0",
    versionID: 10, // nexint raw server version (index.js), plugins are updated independantly
    botChannel: "dev",
